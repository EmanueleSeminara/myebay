	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if (annuncioInstance == null) {
				...
				request.getRequestDispatcher("ExecuteListAnnuncioUtenteServlet?operationResult=NOT_FOUND")
		...
		request.getRequestDispatcher("/annuncio/deleteUser.jsp").forward(request, response);
	}
