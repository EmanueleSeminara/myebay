			  		...
			  		<div class='card'>
					    ...
					    <div class='card-body'>
							...
							<dl class="row">
								...
								<dd class="col-sm-9">${delete_annuncio_attr.utenteInserimento.username}</dd>
							</dl>
					    ...
					    <div class='card-footer'>
					        ...
					        <a href="${pageContext.request.contextPath }/annuncio/ExecuteDeleteAnnuncioUtenteServlet?idAnnuncio=${delete_annuncio_attr.id}" class='btn btn-outline-danger' style='width:100px'>
